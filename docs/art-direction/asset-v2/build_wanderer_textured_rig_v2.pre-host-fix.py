...
def repair_waist_and_hem_weights(body, rig):
    ...
    allowed = {group_index(mesh, name) for name in ("pelvis", "spine", "chest")}
    thigh_ids = {group_index(mesh, "thigh.L"), group_index(mesh, "thigh.R")}
    contamination = 0
    non_normalized = 0
...
def main():
    ...
    report = {
        ...
        "v2": {
            ...
            "tied_hair": {"object": hair.name, "bone": "hair_tie", "material": hair.data.materials[0].name},
